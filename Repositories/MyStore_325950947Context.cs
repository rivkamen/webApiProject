...
public partial class MyStore_325950947Context : DbContext
{
    public MyStore_325950947Context()
    {
    }

    public MyStore_325950947Context(DbContextOptions<MyStore_325950947Context> options)
        : base(options)
    {
    }
